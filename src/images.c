...
/*   Updated: 2024/05/16 19:33:28 by igaguila         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img_player_to_map(t_game *game, char **map, int col, int row)
{
	if (map[row][col] == 'P')
	{
		...
		if ((mlx_image_to_window(game->mlx, game->player_img, col * 64, row
					* 64)) == -1)
...
void	img_btc_to_map(t_game *game, char **map, int col, int row)
{
	if (map[row][col] == 'C')
	{
		...
		if ((mlx_image_to_window(game->mlx, game->btc_img, col * 64, row
					* 64)) == -1)
...
void	img_moon_to_map(t_game *game, char **map, int col, int row)
{
	if (map[row][col] == 'E')
	{
		...
		if ((mlx_image_to_window(game->mlx, game->moon_img, col * 64, row
					* 64)) == -1)
...
void	img_floor_to_map(t_game *game, char **map, int col, int row)
{
	...
	{
		mlx_image_to_window(game->mlx, game->floor_img, col * 64, row * 64);
		if ((mlx_image_to_window(game->mlx, game->floor_img, col * 64, row
					* 64)) == -1)
...
void	img_wall_to_map(t_game *game, char **map, int col, int row)
{
	if (map[row][col] == '1')
	{
		...
		if ((mlx_image_to_window(game->mlx, game->wall_img, col * 64, row
					* 64)) == -1)
